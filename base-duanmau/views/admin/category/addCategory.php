<div class="main-content">
    <div class="container-fluid">
        <h2 class="mb-4"><i class='bxr bxs-category-alt'></i> Thêm Danh Mục Mới</h2>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="index.php?ctl=admin&class=category&act=store" method="POST">
                    
                    <div class="mb-3">
                        <label for="categoryName" class="form-label required">Tên Danh Mục</label>
                        <input type="text" class="form-control" id="categoryName" name="name" required placeholder="Ví dụ: Điện Thoại Thông Minh">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="parentCategory" name="parent_id">
                            <option value="0" selected>-- (Không có) Đây là Danh mục cha cấp 1 --</option>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class='bxr bxs-save'></i> Lưu Danh Mục
                        </button>
                    </div>
                </form>
            </div>
